...
## About me
**QA Analyst** | Manual & Automation Testing | Java |Spring Boot | Selenium, JUnit, TestNG, Mockito, Playwright, Pytest | Ci/CD | Git & GitHub | Docker | K8s | VM | AWS | Gitlab  | Github
