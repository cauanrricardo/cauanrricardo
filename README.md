...
## About me
**QA Analyst** | Manual & Automation Testing | Java | Selenium | Playwright | JUnit | TestNG | Mockito | Pytest | API Testing (RestAssured/Postman) | SQL | CI/CD | Git & GitHub | Docker | AWS | Agile/Scrum
